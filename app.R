  ...
  dashboardBody(
    tabItems(
        ...
        div(
          ...
          tags$ol(
            ...
            tags$li(
              ...
              tags$ul(tags$li(
                HTML("<span style='font-size: 20px;'>Once you have reviewed a sample of records, use this tab to estimate the algorithm’s bias and error.</span>")))
            )
          )
        ),
        fluidRow(
      ...
      tabItem(tabName = "estimation",
        ...
        fluidRow(
          column(12, HTML("<span style='font-size: 20px;'>Once you have reviewed a sample of records, use this tab to estimate the algorithm’s bias and error. <span>"))
        ),
        box(width = 12,
